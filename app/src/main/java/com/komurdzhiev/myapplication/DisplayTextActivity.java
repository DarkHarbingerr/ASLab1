...
public class DisplayTextActivity extends AppCompatActivity {
    ...
    public static final String INPUT_TEXT = "DisplayTextActivity.INPUT_TEXT";
    public static final String TEXTVIEW_KEY = "TextView_Text";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (arg != null) {
            textView = findViewById(R.id.textview_out);
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        String textViewText = savedInstanceState.getString(TEXTVIEW_KEY);
        textView = findViewById(R.id.textview_out);
